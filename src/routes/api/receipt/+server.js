// GET /api/receipt?payment_id=<rzp_id>&pan=<donor_pan>
// Public endpoint donors can use (via the link in their email) to
// re-download their 80G receipt. Requires matching payment_id AND pan.

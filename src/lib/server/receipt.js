// =====================================================
// 80G Receipt generator — produces a PDF buffer per donation.
 ...
 */
export function generateReceipt(d) {
  return new Promise((resolve, reject) => {
    try {
      ...
      // Receipt number — deterministic per payment
      ...
      doc.fillColor('#cbd5e1').font('Helvetica').fontSize(8).text(
        `Niyodaya Foundation · contact@niyodaya.in · niyodaya.in   |   Generated on ${new Date().toLocaleString('en-IN')}`,

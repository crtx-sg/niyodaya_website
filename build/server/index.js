import { H as HttpError, j as json, t as text, S as SvelteKitError, s as set_private_env, a as set_public_env, R as Redirect, p as public_env, e as error, A as ActionFailure, i as isRedirect } from './chunks/shared-server-CO0iTl3r.js';
import { w as with_request_store, t as text_decoder, b as base64_decode, a as afterUpdate, d as decode_pathname, n as normalize_path, c as disable_search, e as decode_params, v as validate_layout_server_exports, f as validate_layout_exports, g as validate_page_server_exports, h as validate_page_exports, i as text_encoder, r as resolve, m as make_trackable, j as get_relative_path, k as base64_encode } from './chunks/ssr2-e2juEaAg.js';
import { c as create_ssr_component, s as setContext, v as validate_component, m as missing_component, n as noop$1, a as safe_not_equal } from './chunks/ssr--GcvDUzA.js';
...
const options = {
  ...
  templates: {
    ...
    <meta name="description" content="Niyodaya Foundation — a new dawn for every child's learning. Education support for underprivileged, displaced, and specially-abled children in India." />
    <meta property="og:title" content="Niyodaya Foundation" />
    <meta property="og:description" content="A new dawn for every child's learning." />
...
async function get_hooks() {
  ...
  let init;
  ({ handle, handleFetch, handleError, handleValidationError, init } = await import('./chunks/hooks.server-sVmCdgX3.js'));
  let reroute;
  let transport;
  return {
    handle,

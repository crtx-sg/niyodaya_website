...
import { v as validate, i as isEmail, s as sendToUserAndAdmin, a as isPhone, r as required } from './validation-DEofG8tH.js';
import 'nodemailer';
...
async function POST({ request }) {
  ...
  if (hasEmail) {
    ...
    const { sendEmail, ackTemplate } = await import('./validation-DEofG8tH.js').then((n) => n.f);
    sendEmail({
...
export { POST };
//# sourceMappingURL=_server-DRyFgBN0.js.map
